...
public class mainInstrumentos {
	...
	public static void main(String[] args) {
		...
		/*   En un grup de música hi ha diferents tipus d’instruments musicals. Hi ha instruments de vent, de corda i de percussió. 
		     ...
		     si s’està tocant un instrument de corda:“Està sonant un instrument de corda” i 
		     si s’està tocant un instrument de percussió:“Està sonant un instrument de percussió”.
		...
		mainInstrumentos instrumentos = new mainInstrumentos();
